...
If you know C++ Turbo Vision, the fastest way to learn rstv is to lean on what
...
The places rstv looks different from the C++ are a small, deliberate set, and
...
what the C++ does, what rstv does instead, and how the rest of the faithful port
plugs back in:
