...
- [`ctrl_to_arrow`](../api/tvision/event/fn.ctrl_to_arrow.html) maps the WordStar
...
- [`hot_key`](../api/tvision/event/fn.hot_key.html) extracts the `~`-delimited
...
[`Keymap`](../api/tvision/keymap/struct.Keymap.html) maps a **chord** to a
[`Command`](../api/tvision/command/struct.Command.html) by name — the same
...
[`Resolve`](../api/tvision/keymap/enum.Resolve.html): a fully matched `Command`,
...
[`resolve_global`](../api/tvision/keymap/fn.resolve_global.html); you rarely call
